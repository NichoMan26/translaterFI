...
const InitPage = (props) => {
  ...
  return(
    <div className={cls.wrapper}>
        <h1>Rules</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque harum odit itaque aut illum aliquid! Iusto, sunt error nemo, asperiores nihil impedit voluptates similique dignissimos est sit dolor mollitia voluptatibus.
        Maiores atque sequi molestias maxime, libero iure illum? Facilis mollitia vero nihil magnam cupiditate doloribus iste autem consequuntur commodi alias illum quam voluptas iure, modi aliquam reprehenderit perferendis, eligendi error!
